            ...
            <tbody>
              ...
              {transacoes.map(t => (
                <tr key={t.id} className="border-b last:border-b-0 hover:bg-muted/40">
                  ...
                  <td className="px-6 py-3 text-muted-foreground">{formatDate(t.data)}</td>
                  <td className={`px-6 py-3 text-right font-semibold ${t.tipo === "RECEITA" ? "text-emerald-600" : "text-rose-600"}`}>
